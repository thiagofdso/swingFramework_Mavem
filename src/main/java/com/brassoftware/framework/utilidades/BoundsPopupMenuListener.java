...
public class BoundsPopupMenuListener implements PopupMenuListener {
     ...
     */
    public final void setMaximumWidth(int maximumWidth) {
     ...
     */
    public final void setPopupAbove(boolean popupAbove) {
     ...
     */
    public final void setPopupWider(boolean popupWider) {
     ...
     */
    public final void setScrollBarRequired(boolean scrollBarRequired) {
